...
public class patternVerification extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pattern_verification);
...
//                        AlertDialog.Builder dlg = new AlertDialog.Builder(patternVerification.this);
...
//                        dlg.show();
                        ...
                        if(count>=1 && count<3) {
                            ...
                            Toast.makeText(patternVerification.this, count + "회 잘못 입력하셨습니다.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(patternVerification.this, "4개 이상의 점을 연결해주세요.", Toast.LENGTH_SHORT).show();
                    mPatternLockView.clearPattern();
                }
