...
public class First_Pattern_Check extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.first_pattern_check);
            ...
            public void onComplete(List<PatternLockView.Dot> pattern) {
                if(PatternLockUtils.patternToString(mPatternLockView, pattern).length() >= 4) {  // 4개 이상의 점이 연결되었을 경우
                    if(password.equals(PatternLockUtils.patternToString(mPatternLockView, pattern))) {
                        ...
                        AlertDialog.Builder dlg = new AlertDialog.Builder(First_Pattern_Check.this);
                        ...
                        if(count<5) {
                            ...
                            mPatternLockView.setViewMode(PatternLockView.PatternViewMode.WRONG);
                            Toast.makeText(First_Pattern_Check.this, "5회 이상 잘못 입력하셨습니다.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(First_Pattern_Check.this, "4개 이상의 점을 연결해주세요.", Toast.LENGTH_SHORT).show();
                    mPatternLockView.clearPattern();
                }
